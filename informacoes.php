                ...
                <ul class="navbar-nav">
                    <li class="nav-item active">
                        <a class="nav-link" style="color: white;" href="index.php">Home<span class="sr-only">(current)</span></a>
                                        ...
                                        <li class="nav-item active">
                        <a class="nav-link" style="color: white;" href="tabelageral.php">Solicitações<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="color: white;" href="#">Perfil</a>
                    </li>
                    <li class="nav-item">
                        <b><a class="nav-link" style="color: white;" href="#">Sair</a></b>
                    </li>
                </ul>
            </div>
        </div>
